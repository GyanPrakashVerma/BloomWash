...
<head>
    ...
    <title>Bloom Wash | Comming Soon</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon -->
     <link rel="shortcut icon" type="image/x-icon" href="coomingsoon/logo.png"> 
    <!-- Bootstrap CSS -->
...
<body>
    <div id="wrapper" class="wrapper">
        <div class="fxt-template-default fxt-template-layout12" data-bg-image="frontend/style/img/banner.jpg"></div>
        ...
        <div class="fxt-content-wrap-layout12">
            ...
            <div class="fxt-content-box fxt-content-box-layout12">
                <h1 class="fxt-item-title fxt-transformY-100 fxt-transition-delay-10">COMING SOON</h1>
    ...
    $(function() {
        ...
        if (eventCounter.length) {
            eventCounter.countdown("2022/09/08", function(e) {
                $(this).html(
                    e.strftime(
